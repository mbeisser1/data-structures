...
%%%MOCHI_CARD%%%
Show uniform initialization examples. #q73 #uniform-init #cpp11-beyond
...
Also works for **member initialization**: `int x{x_val}, y{y_val};`
...
**`()`** vs **`{}`** can call **different** overloads — know which you intend.
