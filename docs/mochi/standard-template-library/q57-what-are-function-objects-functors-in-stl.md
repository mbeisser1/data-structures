...
%%%MOCHI_CARD%%%
Show a unary predicate functor with `std::remove_if`. #q57 #functors #stl
...
%%%MOCHI_CARD%%%
Show a stateful functor with `std::transform`. #q57 #functors #stl
...
%%%MOCHI_CARD%%%
Show modern C++ functor alternatives. #q57 #functors #stl
